...
nobs      = 2034;   % number of observations per trial
nvars     = 7;       % number of nodes
...
rawdata = h5read('/Users/zhangyaguang/Desktop/MSc Project/Results/VE/adNew.h5', '/data');
...
% title(['Significant at p = ' num2str(alpha)]);
 print('/Users/zhangyaguang/Desktop/ad','-dpng','-r800');
