...
set(gca,'XTick',1:7,...                         %# Change the axes tick marks
        'XTickLabel',{'LOC','OP','AG','Thal','PlanPol','MFG','IFG'},...  %#   and tick labels
        'YTick',1:7,...
        'YTickLabel',{'LOC','OP','AG','Thal','PlanPol','MFG','IFG'},...
        'TickLength',[0 0]);

    
line(xlim,ylim,'Color','k','LineStyle','--');
textStrings = num2str(P(:),'%0.1g');  %# Create strings from the matrix values
